...
#undef create_pixel_shader_helper
    ...
    ID3D11RenderTargetView *out_Y_or_YUV_rtv = nullptr;  ///< Active Y or packed-YUV render target.
    ID3D11RenderTargetView *out_UV_rtv = nullptr;  ///< Active UV render target.
    ...
    ID3D11Texture2D *output_texture = nullptr;  ///< Active output texture.
    std::map<ID3D11Texture2D *, output_target_t> output_targets;  ///< Cached views for AMF's input ring.
