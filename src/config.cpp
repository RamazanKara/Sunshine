...
namespace config {
  ...
  namespace amd {
    ...
    constexpr int AMF_VIDEO_ENCODER_AV1_RATE_CONTROL_METHOD_QUALITY_VBR = 4;  ///< Fallback AMF enum value for AV1 QVBR.
    constexpr int AMF_VIDEO_ENCODER_AV1_RATE_CONTROL_METHOD_HIGH_QUALITY_VBR = 5;  ///< Fallback AMF enum value for AV1 HQVBR.
    constexpr int AMF_VIDEO_ENCODER_AV1_RATE_CONTROL_METHOD_HIGH_QUALITY_CBR = 6;  ///< Fallback AMF enum value for AV1 HQCBR.
    ...
    constexpr int AMF_VIDEO_ENCODER_HEVC_RATE_CONTROL_METHOD_QUALITY_VBR = 4;  ///< Fallback AMF enum value for HEVC QVBR.
    constexpr int AMF_VIDEO_ENCODER_HEVC_RATE_CONTROL_METHOD_HIGH_QUALITY_VBR = 5;  ///< Fallback AMF enum value for HEVC HQVBR.
    constexpr int AMF_VIDEO_ENCODER_HEVC_RATE_CONTROL_METHOD_HIGH_QUALITY_CBR = 6;  ///< Fallback AMF enum value for HEVC HQCBR.
    ...
    constexpr int AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD_QUALITY_VBR = 4;  ///< Fallback AMF enum value for H.264 QVBR.
    constexpr int AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD_HIGH_QUALITY_VBR = 5;  ///< Fallback AMF enum value for H.264 HQVBR.
    constexpr int AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD_HIGH_QUALITY_CBR = 6;  ///< Fallback AMF enum value for H.264 HQCBR.
